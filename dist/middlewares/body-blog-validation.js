...
exports.bodyBlogValidation = {
    ...
    websiteUrl: (0, express_validator_1.body)('websiteUrl').notEmpty().isString().trim().isLength({ min: 1, max: 100 }).matches('https?:\\/\\/(www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_\\+.~#?&//=]*)')
};
